...
% only two objectives error vs complexity
...
%Eliminating some matches == some weights == 0 initialised
        ...
        if rand < P_move_prey
            ...
            for j = 1:10 %10 trial for free spot
                ...
                if lattice(xpos+dx,ypos+dy) == 0
                    lattice(xpos,ypos) = 0; %removing prey i from lattice
...
FinalPlotSave(figure(4),'Final Marked Plot')
